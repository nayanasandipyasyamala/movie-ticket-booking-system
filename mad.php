...
<html>
<head>
    <title>Mad Square Details</title>
...
<body>
    ...
    <div class="Top-section">
        ...
        <div class="content">
            <div class="poster">
                <img src="https://assets-in.bmscdn.com/iedb/movies/images/mobile/thumbnail/xlarge/mad-square-et00435629-1740499947.jpg" alt="Poster">
            </div>
            <div class="details">
                <h1>Mad Square</h1>
                <p><strong>Release Date:</strong>28 Mar, 2025</p>
                <div>
    ...
    <div class="Bottom-section mt-5 mb-3 m-3">
        ...
        <p>Mad Square is a Telugu movie starring Narne Nithin, Sangeeth Shobhan, Ram Nithin and Priyanka Jawalkar in prominent roles. It is written and directed by Kalyan Shankar.</p>
        <hr class="mt-5">   
        <h2><strong>Top Cast</strong></h2>
        <div class="cast-container">
            <div class="cast-member">
                <img src="https://assets-in.bmscdn.com/iedb/artist/images/website/poster/large/narne-nithin-2031118-1695792694.jpg" class="cast-image"/>
            ...
            <div class="cast-member">
                <img src="https://assets-in.bmscdn.com/iedb/artist/images/website/poster/large/sangeeth-shobhan-2031119-1695792893.jpg" class="cast-image"/>
                <div class="cast-details">
                    <p>Sangeeth Shobhan</p>
                    <p>Actor</p>
                </div>
            </div>
            <div class="cast-member">
                <img src="https://assets-in.bmscdn.com/iedb/artist/images/website/poster/large/priyanka-jawalkar-1083941-29-06-2017-21-42-44.jpg" class="cast-image"/>
                <div class="cast-details">
                    <p>Priyanka Jawalkar</p>
                    <p>Actor</p>
                </div>
            </div>
            <div class="cast-member">
                <img src="https://assets-in.bmscdn.com/iedb/artist/images/website/poster/large/ram-nithin-2031120-1695793827.jpg" class="cast-image"/>
                <div class="cast-details">
                    <p>Ram Nithin</p>
                    <p>Actor</p>
                </div>
           ...
           <div class="cast-member">
            <img src="https://assets-in.bmscdn.com/iedb/artist/images/website/poster/large/kalyan-shankar-2031122-1695794630.jpg" class="cast-image"/>
            <div class="cast-details">
                <p>Kalyan Shankar</p>
                <p>Director, Writer</p>
            </div>
